% Demo for depth-based gait recognition
%
...
mattracks = './data/005-n-05_W01_H02_depth.mat';
load(mattracks); % Contains variable 'detections'

% Load dictionary for FV, already learnt
matdic = './data/full_dictionary_K=0600_depth.mat';
load(matdic)
...
matsvm = 'full_model_svmlin_K=0600_PCAH256_nFrames=0000_overlap=00_depth.mat';
